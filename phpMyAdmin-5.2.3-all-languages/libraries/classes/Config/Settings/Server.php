...
final class Server
{
    ...
    /**
     * SOCKS5 proxy for MySQL connection (requires socat)
     * Format: 'host:port'
     *
     * @var string
     */
     ...
     * @param array<int|string, mixed> $server
     */
    private function setSocks5Proxy(array $server): string
    {
        if (isset($server['socks5_proxy'])) {
            return (string) $server['socks5_proxy'];
        }
     ...
     * @param array<int|string, mixed> $server
     */
    private function setSocks5User(array $server): string
    {
        if (isset($server['socks5_user'])) {
            return (string) $server['socks5_user'];
        }
     ...
     * @param array<int|string, mixed> $server
     */
    private function setSocks5Pass(array $server): string
    {
