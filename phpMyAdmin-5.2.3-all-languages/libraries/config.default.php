 ...
 *
 * @global string $cfg['Servers'][$i]['socks5_proxy']
 */
$cfg['Servers'][$i]['socks5_proxy'] = '';

/**
 * Username for SOCKS5 proxy authentication (optional)
 *
 * @global string $cfg['Servers'][$i]['socks5_user']
 */
$cfg['Servers'][$i]['socks5_user'] = '';

/**
 * Password for SOCKS5 proxy authentication (optional)
 *
 * @global string $cfg['Servers'][$i]['socks5_pass']
 */
